...
public class CmsQtController {
	...
	public AjaxResult getColumnList(HttpServletRequest request,HttpServletResponse response){
		...
		if(StringUtils.isNotBlank(isRootColumnLikeStr) && "1".equals(isRootColumnLikeStr)){
	...
	public AjaxResult getArticle(HttpServletRequest request,HttpServletResponse response){
		...
		if(StringUtils.isNotBlank(articleId)){
			...
			if(article != null){
			    ...
			    this.articleService.view(article.getViewCount(),article.getId());
